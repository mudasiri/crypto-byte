  ...
  return (
    <>
      <header className="detailHeader">
        <Link to="/"><img src={backArrow} alt="back-main" /></Link>
        <p>Stockbyte</p>
      </header>
        ...
        {data.map((crypto) => (
          <>
            ...
            <div className="crypto-item evenItem">
              <h2>
                Highest Rate:
                {new Intl.NumberFormat('gh-GH').format(crypto.high.toFixed(2))}
                {' '}
                <span> GHS</span>
              </h2>
            </div>
            <div className="crypto-item">
              <h2>
                Lowest Rate:
                {new Intl.NumberFormat('gh-GH').format(crypto.low.toFixed(2))}
                {' '}
                <span> GHS</span>
              </h2>
            </div>
